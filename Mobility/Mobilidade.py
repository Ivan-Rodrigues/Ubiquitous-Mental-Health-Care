...
user_id = ['u00','u01','u02','u03','u04','u05','u08','u09','u10','u12','u13','u14','u15','u16','u17','u18','u19','u20','u22',
        'u23','u25','u27','u30','u31','u32','u34','u35','u36','u41','u42','u45',
   'u46','u51','u52','u57','u58','u59']
...
#df_all.to_csv('mobility.csv')

df_all = pd.read_csv('../SensingData/mobility.csv',header=[0,1], index_col=[0])
...
df_feature.to_csv('feature_phq9_all.csv')
...
layout = go.Layout(title = 'Semanas (Acompanhamento)',

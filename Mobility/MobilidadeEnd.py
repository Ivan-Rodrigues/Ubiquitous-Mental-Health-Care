...
user_id = ['u00','u01','u02','u04','u05','u08','u09','u10','u12','u13','u14','u16','u17','u18','u19','u20','u22','u23',
'u27','u30','u31','u32','u34','u35','u36','u41','u42','u45','u46','u51','u52','u57','u58','u59'
]
#'u44',,'u43','u54', 'u33','u39', home stay
#,,'u15','u25'   'u03'
user_clt = []
...
for uid in user_clt:
    ...
    gps_data = gps_data[(gps_data['week_day']==5) | (gps_data['week_day']==6)]
...
#df_all.to_csv('mobility_weekend.csv')

df_all = pd.read_csv('../SensingData/mobility_weekend.csv',header=[0,1], index_col=[0])
...
df_feature.to_csv('feature_phq9_weekend.csv')
...
data = [trace1,trace7, trace8,trace9]

layout = go.Layout(title = 'Mobilidade Fim de Semana (Acompanhamento)',
